...
class SpotifyHandler():
    def __init__(self):
        spotify_config = util.get_config2()['spotipy']
    ...
    def get_recommendations(self, seed_genres=None, seed_artists=None, seed_tracks=None, limit=10, **kwargs):
        ...
        reco = self.sp.recommendations(seed_genres=seed_genres, seed_artists=seed_artists, seed_tracks=seed_tracks, country='FR', limit=limit, **kwargs)
