...
<section class="w-full">
	{#if $currentUser}
		...
		<div class="p-4">
			<div
				class="flex p-4 items-center h-28 bg-cover rounded-sm"
				style="background-image: url('https://placekitten.com/1280/720')"
			>
			...
			<div class="flex flex-wrap justify-around">
				<div
					class="w-2/5 flex p-4 items-center h-36 bg-cover rounded-sm"
		...
		<form on:submit|preventDefault>
			...
			<div class="form-control w-full max-w-xs">
				...
				<input
					...
					bind:value={password}
				/>
				<button type="submit" class="btn btn-primary" on:click={login(email, password)}
					>Se connecter</button
				>
			</div>
		</form>
